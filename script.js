        ...
        class e {
          ...
          async loadScript(t) {
            const e = t.getAttribute("data-src"),
              ...
              d = t.hasAttribute("data-required"),
              s = "module" === t.getAttribute("type");
            ...
            if (!this.isDuplicate(i || "")) {
              ...
              try {
                const e = t.getAttribute("data-cdn-url") || this.config.cdnUrl,
                  ...
                  d = await this.retrieveHCS1Data(i, e, o),
                  s = await d.text(),
                ...
                if (
                  (this.error("Failed to load stylesheet: " + a, d),
                  this.updateLoadingStatus(a, "failed"),
                  o)
                )
                  throw d;
          ...
          async loadMedia(t, e) {
            ...
            try {
              const a = t.getAttribute("data-cdn-url") || this.config.cdnUrl,
                o = t.getAttribute("data-network") || this.config.network,
                d = await this.retrieveHCS1Data(i, a, o),
                s = URL.createObjectURL(d);
              (t.src = s),
                "video" === e
                  ? (this.LoadedVideos[i] = s)
                  : (this.LoadedAudioUrls[i] = s),
          ...
          async loadGLB(t) {
            ...
            const a = t.getAttribute("data-src"),
              i = null == a ? void 0 : a.split("/").pop();
            this.log("Loading GLB: " + i),
              this.updateLoadingStatus("GLB: " + i, "loading");
            try {
              const a = t.getAttribute("data-cdn-url") || this.config.cdnUrl,
                o = t.getAttribute("data-network") || this.config.network;
              let d;
              "model-viewer" !== t.tagName.toLowerCase()
                ? ((d = document.createElement("model-viewer")),
                  Array.from(t.attributes).forEach((t) => {
                    d.setAttribute(t.name, t.value);
                  }),
                  d.setAttribute("camera-controls", ""),
                  d.setAttribute("auto-rotate", ""),
                  d.setAttribute("ar", ""),
                  null == (e = t.parentNode) || e.replaceChild(d, t))
                : (d = t);
              const s = await this.retrieveHCS1Data(i, a, o),
                r = URL.createObjectURL(s);
              d.setAttribute("src", r),
                (this.LoadedGLBs[i] = r),
                this.updateLoadingStatus("GLB: " + i, "loaded"),
                this.log("Loaded GLB: " + i);
            } catch (o) {
              this.error("Failed to load GLB: " + i, o),
                this.updateLoadingStatus("GLB: " + i, "failed");
            }
          }
              ...
              new Promise((t) => {
                const e = async () => {
                  const e = document.querySelectorAll(
                    ...
                    s = document.querySelectorAll('link[data-src^="hcs://"]'),
                    r = [];
                  [
